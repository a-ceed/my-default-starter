        ...
        <section id="one" className="main alt">
            ...
            <div className="inner alt">
                <div className="content">
                    ...
                    <p>В результате исследований была разработана специальная методика, которая помогает детям находиться в движении весь день. При этом показатели физического, психического здоровья и успеваемость растут! Заболеваемость детей снижается с 90-100% до 5-10%. На данной момент методика является единственной одобренной Роспотребнадзором и Минздравом России.</p>


                    <h3>Как организован процесс обучения?</h3>
                    <p>Основной элемент методики — это нахождение ребенка в вертикальной позе, естественной для любого человека. Дети учатся в режиме динамической смены поз — стоя за конторкой и сидя за партой, меняясь местами каждые 10 минут. Используются массажные коврики для стоп и массажные мячики для ладоней, дети занимаются на зрительно-вестибулярных тренажерах и шведской стенке с турником, а также используются десятки других полезных для здоровья элементов.</p>
